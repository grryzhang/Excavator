...
@Service ( "postgresql.CorporationDAO" )
public interface CorporationDAO {
	...
	public int countCorporationByDuplicateName( CorporationSearchParameters searchParameters ) throws SQLException;
	 ...
	 */
	public List<Corporation> selectCorporationByDuplicateName( CorporationSearchParameters searchParameters) throws SQLException;
