...
public class CorporationServiceImpl implements NCCorporationService{
	...
	public void migrateCorporations( CorporationSearchParameters searchParameters ) throws ServiceRuntimeException{
		...
		try {
			...
			com.zhongzhou.Excavator.model.masterdata.CorporationSearchParameters clearSearchParameters
			= new com.zhongzhou.Excavator.model.masterdata.CorporationSearchParameters();
			clearSearchParameters.setLimit(null);
			clearSearchParameters.setStart(null);
	...
	@Transactional(
			...
			readOnly=false,
			rollbackFor=Exception.class )
	public void clearRecords( com.zhongzhou.Excavator.model.masterdata.CorporationSearchParameters searchParameters )  
			throws SQLException{
