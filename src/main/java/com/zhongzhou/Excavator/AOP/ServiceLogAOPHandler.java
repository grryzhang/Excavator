 ...
 *
 */
public class ServiceLogAOPHandler {
	
	private static Logger log = Logger.getLogger(ServiceLogAOPHandler.class);  
	...
	public void interceptLogRequest(){
		
	}
	
	@Around(value="interceptLogRequest()")  
	public Object saveLog( final ProceedingJoinPoint pjp ) throws Throwable{
